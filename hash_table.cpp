...
int main() {
    try {
        ...
        P.remove(135);
        std::cout << P.get(135).key << " " << P.get(135).value << "\n"
                  << P.get(1135).key << " " << P.get(1135).value << "\n"
                  << P.get(145).key << " " << P.get(145).value << "\n"
                  << P.get(35).key << " " << P.get(35).value << "\n"
                  << P.get(13).key << " " << P.get(13).value << "\n";
